...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] Database}\\[2\baselineskip] % Title
{\large \textit{MySQL}}\\[4\baselineskip] % Tagline or further description
